package com.kvs.utils.XMLConfigKit
{
	...
	import com.kvs.utils.XMLConfigKit.effect.Blur;
	import com.kvs.utils.XMLConfigKit.effect.Effects;
	import com.kvs.utils.XMLConfigKit.effect.Glow;
	import com.kvs.utils.XMLConfigKit.effect.Shadow;
	import com.kvs.utils.XMLConfigKit.shape.CircleShape;
	import com.kvs.utils.XMLConfigKit.shape.Diamond;
	import com.kvs.utils.XMLConfigKit.shape.RectShape;
	import com.kvs.utils.XMLConfigKit.shape.Triangle;
	...
	public class XMLVOLib
	{
		...
		{
			registerCustomClasses(<{key} path='com.kvs.utils.XMLConfigKit.style.LabelStyle'/>);
		}
		...
		{
			registerCustomClasses(<{key} path='com.kvs.utils.XMLConfigKit.style.Style'/>);
		}
		...
		private var registedClasses:XML = 
							<classes>
								<!--基础样式元素-->
								<border path='com.kvs.utils.XMLConfigKit.style.elements.BorderLine'/>
								<cover path='com.kvs.utils.XMLConfigKit.style.elements.Cover'/>
								<fill path='com.kvs.utils.XMLConfigKit.style.elements.Fill'/>
								<format path='com.kvs.utils.XMLConfigKit.style.elements.TextFormatStyle'/>
								<img path='com.kvs.utils.XMLConfigKit.style.elements.Img'/>
								
								<!--样式模型-->
								<label path='com.kvs.utils.XMLConfigKit.style.LabelStyle'/>
								<text path='com.kvs.utils.XMLConfigKit.style.Text'/>
								<states path='com.kvs.utils.XMLConfigKit.style.States'/>
								<bg path='com.kvs.utils.XMLConfigKit.style.ContainerStyle'/>
								<normal path='com.kvs.utils.XMLConfigKit.style.Style'/>
								<hover path='com.kvs.utils.XMLConfigKit.style.Style'/>
								<down path='com.kvs.utils.XMLConfigKit.style.Style'/>
								<style path='com.kvs.utils.XMLConfigKit.style.Style'/>
								
								<!-- 滤镜效果-->
								<effects path='com.kvs.utils.XMLConfigKit.effect.Effects'/>
								<shadow path='com.kvs.utils.XMLConfigKit.effect.Shadow'/>
								<blur path='com.kvs.utils.XMLConfigKit.effect.Blur'/>
								<glow path='com.kvs.utils.XMLConfigKit.effect.Glow'/>
								<noise path='com.kvs.utils.XMLConfigKit.effect.Noise'/> 
								
								<!--形状-->
								<circle path='com.kvs.utils.XMLConfigKit.shape.CircleShape'/>
								<rect path='com.kvs.utils.XMLConfigKit.shape.RectShape'/>
								<diamond path='com.kvs.utils.XMLConfigKit.shape.Diamond'/>
								<triangle path='com.kvs.utils.XMLConfigKit.shape.Triangle'/>
