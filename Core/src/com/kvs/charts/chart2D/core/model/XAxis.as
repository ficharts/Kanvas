package com.kvs.charts.chart2D.core.model
{
	...
	import com.kvs.charts.chart2D.core.axis.DateAxis;
	import com.kvs.charts.chart2D.core.axis.FieldAxis;
	...
	public class XAxis implements IEditableObject
	{
		...
		public function beforeUpdateProperties(xml:* = null):void
		{
			...
			XMLVOMapper.fuck(XMLVOLib.getXML(Chart2DModel.X_AXIS_STYLE, Model.SYSTEM), axis);
