package com.kvs.ui
{
	...
	public class Scale9GridSprite extends Sprite
	{
		...
		public function Scale9GridSprite(source:Object, rectangle:Rectangle = null)
		{
			...
			grid02 = getBitmap(rect.right, 0, _width - rect.right, rect.top);
			
			grid10 = getBitmap(0, rect.top, rect.left, rect.height);
			grid11 = getBitmap(rect.left, rect.top,rect.width, rect.height);
			grid12 = getBitmap(rect.right, rect.top, _width - rect.right, rect.height);
			
			grid20 = getBitmap(0, rect.bottom,rect.left, _height - rect.bottom);
			grid21 = getBitmap(rect.left, rect.bottom, rect.width, _height - rect.bottom);
			grid22 = getBitmap(rect.right, rect.bottom, _width - rect.right, _height - rect.bottom);
		...
		public function getBitmap(x:Number, y:Number, width:Number, height:Number):DisplayObject
		{
			...
			bitmapData.copyPixels(_sourceData, new Rectangle(x, y, width, height), new Point(0, 0));
