...
package model 
{
	import com.kvs.charts.chart2D.encry.LM;
	 ...
	 * 负责解密、License验证、水印显示
	 */	
	public class DecForKvs
	{
		public function DecForKvs(shell:Sprite)
		{
			this.shell = shell;
		...
		public function verify():void
		{
			...
			if (XMLVOLib.currentLib == null)
				XMLVOLib.currentLib = new XMLVOLib; 
		...
		/**
		 */		
		private var waterText:String = '非法使用';
		...
		private function layoutWaterLabel():void
		{
			...
			waterLabel.x = (shell.stage.stageWidth - waterLabel.width) / 2;
			waterLabel.y = (shell.stage.stageHeight - waterLabel.height) / 2;
		}
