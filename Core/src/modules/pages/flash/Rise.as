package modules.pages.flash
{
	...
	public class Rise implements IFlash
	{
		...
		public function next():void
		{
			...
			for each (var item:IElement in elements)
			{
				...
				p = item.canvas.stagePointToCanvas(item.canvas.canvasPointToStage(item.x, item.y).x, item.canvas.stage.stageHeight + rect.height);
