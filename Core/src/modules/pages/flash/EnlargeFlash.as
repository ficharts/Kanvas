package modules.pages.flash
{
	...
	/**
	 */	
	public class EnlargeFlash implements IFlash
	{
		public function EnlargeFlash()
		{
		}
		...
		{
			return <enlarge elementID={elementID} index={index}/>;
		}
		...
		public function next():void
		{
			...
			for each (var item:IElement in elements)
			{
				...
				TweenLite.from(item, FadeIn.TIME, {scale:0, ease: Back.easeOut});
			}
		}
