			...
			if (enable && !GestureControl.gestureControl)
			{
				...
				else
				{
					...
					for each (element in elements)
					{
						...
						if (Object(element).flashShape && Object(element).flashShape.alpha >= 1 && bound.width > 20 && bound.height > 20 &&　bound.contains(mdt.mainUI.stage.mouseX, mdt.mainUI.stage.mouseY))
						{
